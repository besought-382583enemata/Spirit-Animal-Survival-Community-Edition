...
# 🎮 Spirit Animal Survival — Community Edition

**Survive the wild with your spirit animal by your side.**
...
Spirit Animal Survival is an open-world survival game set in a mystical wilderness where players tame spirit animal companions, craft tools, and build shelters to endure dynamic seasons and wildlife threats. This Community Edition is a standalone, self-contained package that runs entirely offline with no storefront or additional software required. All content is included and ready to play immediately after installation.

This build is for players who want a complete, self-contained offline copy of Spirit Animal Survival for Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/745810/ss_49897d0be74797c6bd74e65e2054c44f16664407.1920x1080.jpg?t=1789461437" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/745810/ss_ec2055407f56dc901c238e72cf8118360c064805.1920x1080.jpg?t=1789461437" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/745810/ss_93ef510275e8a5c13bd293c0cfcd0f86ccb4667c.1920x1080.jpg?t=1789461437" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🌲 **Open-World Exploration** — Roam a vast mystical wilderness with biomes ranging from dense forests to frozen peaks.
- 🦊 **Spirit Animal Companions** — Bond with and raise spirit animals that grant unique survival abilities.
- 🛠️ **Deep Crafting System** — Gather resources to craft tools, weapons, clothing, and camp equipment.
- 🏕️ **Base Building** — Construct and upgrade shelters to withstand weather, wildlife, and the long night.
- 🌦️ **Dynamic Weather & Seasons** — Adapt to shifting seasons, storms, and day-night cycles that affect survival.
- 🌐 **Multiplayer** — LAN or direct connection supported for cooperative play with friends.
- 🔌 **Fully Offline Capable** — Complete single-player experience that runs without an internet connection.
- 📦 **Self-Contained Package** — Standalone build with all content included and no additional software required.
...
| **Processor** | Intel Core i5-4460 / AMD Ryzen 3 1200 | Intel Core i7-8700 / AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 960 / AMD Radeon R9 380 (4 GB VRAM) | NVIDIA GeForce GTX 1660 / AMD Radeon RX 5600 XT (6 GB VRAM) |
| **Storage** | 20 GB available space | 20 GB available space on SSD |
| **Additional** | DirectX 11 compatible system | DirectX 12 compatible system |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\SpiritAnimalSurvival\Saved`
